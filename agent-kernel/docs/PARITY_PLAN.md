...
| Skills System | 50% | ✅ 3 skills (simplify, review, commit), dynamic loading from .agent-kernel/skills |
...
| Permissions | 75% | ✅ Pattern-matching rules, ✅ Default allow/deny/ask, ✅ ~/.agent-kernel/permissions.json |
...
**Files modified:** `agent-kernel/cli/index.ts`
...
**Files modified:** `agent-kernel/src/sidecars/permissions.ts`, `agent-kernel/src/sidecars/tool-registry.ts`
...
✅ Load from `~/.agent-kernel/permissions.json`
✅ Pattern matching with regex

#### P1.3: Streaming Responses ✅ DONE
**Files modified:** `agent-kernel/src/core/lean-agent.ts`
...
**Files modified:** `agent-kernel/cli/index.ts`, `agent-kernel/src/core/session-store.ts`

- ✅ Agent accumulates messages across turns in conversation array
- ✅ Session store with JSONL persistence at `~/.agent-kernel/sessions/`
...
**Files to modify:** `agent-kernel/src/core/lean-agent.ts`
...
**Files to modify:** `agent-kernel/src/sidecars/tool-registry.ts`
...
**Files to modify:** `agent-kernel/cli/index.ts`
...
**Files to modify:** `agent-kernel/src/core/task-store.ts`
...
**Files to add:** `agent-kernel/src/core/subagent.ts`
...
**Files to modify:** `agent-kernel/src/sidecars/mcp-client.ts`

- [ ] Auto-load `~/.agent-kernel/mcp.json` on startup
...
**Files to modify:** `agent-kernel/src/skills/loader.ts`

- [ ] Hot-reload skills from `.agent-kernel/skills/`
- [ ] Skill schema validation
- [ ] Usage tracking

#### P3.4: Hooks System
**Files to add:** `agent-kernel/src/core/hooks.ts`
...
3. **MCP auto-load** (3-4 hours) - load from `~/.agent-kernel/mcp.json`
