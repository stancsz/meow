 ...
 *
 * First-run detection: checks ~/.agent-kernel/sessions/ for any session files
 * Onboarding state persists in ~/.agent-kernel/config.json (has_seen_onboarding)
 */
...
const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    tip: "Tasks persist in .agent-kernel/tasks.json and survive restarts.",
  },
  {
    title: "You're ready! 🚀",
