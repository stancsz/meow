/**
 * acp-mode.ts - Harvested skill for ACP mode capability
 *
 * ACP (Agent Client Protocol) enables programmatic control of Meow
 * from IDEs and tools via JSON-RPC over stdio.
 */

import { type Skill } from "./loader.ts";

// YAML frontmatter escaped in template literal
const DESCRIPTION = `---
name: acp-mode
...
export const acp_mode: Skill = {
  name: "acp-mode",
  description: DESCRIPTION,
  async execute(context) {
    // TODO: Implement acp-mode capability
    return { success: true, message: "acp-mode capability" };
  },
};
