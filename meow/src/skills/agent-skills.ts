 ...
 * Minimal slice: A minimal agent-skills loader: reads skill definitions from ~/.meow/skills/, registers them dynamically, exposes /skills command.
 */
...
- Community skill sharing",
  async execute(context) {
    ...
    // A minimal agent-skills loader: reads skill definitions from ~/.meow/skills/, registers them dynamically, exposes /skills command.
