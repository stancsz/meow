 ...
 * Minimal slice: Create src/skills/agency.ts that defines an agent personality system. Each agency agent has: name, description, personality traits, rules, and communication style. Load agents from YAML/JSON config files.
 */
...
export const agency_agents: Skill = {
  name: "agency-agents",
  description: "# Agency Agents Capability
...
- Natural extension of the existing skill system",
  async execute(context) {
    // TODO: Implement agency-agents capability from https://github.com/msitarzewski/agency-agents
    // Create src/skills/agency.ts that defines an agent personality system. Each agency agent has: name, description, personality traits, rules, and communication style. Load agents from YAML/JSON config files.
